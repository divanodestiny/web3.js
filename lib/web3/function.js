...
SolidityFunction.prototype.toPayload = function (args) {
    ...
    var signHash = this._eth.getSignHash(options);
 ...
 * @param {Object} options (optional) The options of the contract's function
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return this.getResult(this._eth.invokeContract(payload));
    }
    else {
        this._eth.invokeContract(payload, (error, result) => {
            if (error) {
                ...
                this.getResult(result, callback);
            }
        });
    }
};
 ...
 * @method getResult
 * @param {String} hash The hash value of transaction
 * @param {Function} callback The callback function shoulb be able to receipt {Error} and {Array} as params
